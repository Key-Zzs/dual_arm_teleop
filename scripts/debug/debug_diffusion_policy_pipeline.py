...
def resolve_policy_path(policy: dict[str, Any], policy_type: str, mode: str) -> Path:
    try:
        ...
        if raw_path is None:
            ...
            raw_path = f"scripts/config/policy_config/{stem}_{mode}_config.yaml"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=str(SCRIPTS_DIR / "config" / "policy_config" / "diffusion_train_config.yaml"),
    )
    parser.add_argument(
        "--diffusion-reason-config",
        default=str(SCRIPTS_DIR / "config" / "policy_config" / "diffusion_reason_config.yaml"),
    )
